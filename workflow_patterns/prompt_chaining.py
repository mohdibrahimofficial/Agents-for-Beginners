...
def generate_confirmation(event_details: EventDetails) -> EventConfirmation:
    ...
    completion = client.beta.chat.completions.parse(
        ...
        messages=[
            {
                "role": "system",
                "content": "Generate a natural confirmation message for the event. Use the professional tone. Sign of with your name; Sales Head",
            },
...
user_input = input("I am a Meeting schedule Assistant. How can I help you?\n")
