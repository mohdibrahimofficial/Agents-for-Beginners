...
# Words
The content should be top rated for SEO and AEO
...
class BlogOrchestrator:
    ...
    async def get_plan(self, topic: str, target_length: int, style: str) -> OrchestratorPlan:
    ...
    async def write_section(self, topic: str, section: SubTask) -> SectionContent:
    ...
    async def review_post(self, topic: str, plan: OrchestratorPlan) -> ReviewFeedback:
    ...
    async def write_blog(
        ...
        plan = await self.get_plan(topic, target_length, style)
        ...
        for section in plan.sections:
            ...
            content = await self.write_section(topic, section)
            self.sections_content[section.section_type] = content

        # Review and polish
        logger.info("Reviewing full blog post")
        review = await self.review_post(topic, plan)
...
async def main():
    ...
    result = await orchestrator.write_blog(
